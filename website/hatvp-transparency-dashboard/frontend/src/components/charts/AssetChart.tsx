...
export default function AssetChart({ items, emptyLabel, language, compact = false, chartLabel = "Observed asset values by section" }: { items: BreakdownItem[]; emptyLabel: string; language: Language; compact?: boolean; chartLabel?: string }) {

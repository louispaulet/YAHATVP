...
export const highlights = {
  ...
  unusualAssets: [{ declarationUuid: "fixture-uuid-asset", firstName: "Monique", lastName: "BARBUT",
    mandate: "Membre du Gouvernement", section: "bienDiverDto", assetName: "diamant solitaire",
    rawValue: "30000", amount: 30_000, anomalyStatus: "clean", reviewRequired: false }],

...
def _row() -> Row:
    return Row(
        ...
        sources_json=json.dumps([{"source_id": "hatvp_website", "declaration_count": 9, "raw_declaration_count": 12}]),
...
def test_health_payload_maps_layer_source_quality_and_anomaly_values() -> None:
    ...
    assert payload["sources"] == [{"sourceId": "hatvp_website", "declarations": 9, "rawDeclarations": 12}]

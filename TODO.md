...
- [x] Show women’s percentage by position, keep total-position ordering, and make the chart legend responsive.
- [x] Explain the top-10 popularity ordering directly below the women’s-share chart title.
...
- [x] Create the canonical website tone-of-voice guide and require it from `agents.md`.
